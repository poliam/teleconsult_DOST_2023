...
def dashboard(request):
	...
	for consultation in today_consultation:
		...
		today_consultation_list.append({"consultation_id": consultation.pk, "consultation_type": consultation.reason_for_interaction, "patient_name": patient_name, "hamd_score": int(hamd_details.score), "consult_by": consultation.consulted_by.pk})
