...
class global_psychotrauma_screen(models.Model):
	...
	physical_violence = models.CharField(max_length=30, choices=VIOLENCE_CHOICES, default='to yourself', null=True, blank=True)
	sexual_violence = models.CharField(max_length=30, choices=VIOLENCE_CHOICES, default='to yourself', null=True, blank=True)
	emotional_abuse = models.CharField(max_length=30, choices=VIOLENCE_CHOICES, default='to yourself', null=True, blank=True)
	serious_injury = models.CharField(max_length=30, choices=VIOLENCE_CHOICES, default='to yourself', null=True, blank=True)
	life_threatening = models.CharField(max_length=30, choices=VIOLENCE_CHOICES, default='to yourself', null=True, blank=True)
